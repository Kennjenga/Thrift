            ...
            <div className="flex items-center justify-center flex-col py-12">
              ...
              >
                <div className="flex items-start">
                  ...
                  <p>
                    This administrative interface is restricted to authorized
                    personnel only. If you believe you should have access,
                    please verify you are connected with the correct wallet
                    address.
                  </p>
                </div>
              </motion.div>
          ...
          <div className="space-y-4">
            <div className="backdrop-blur-md bg-purple-900/30 border border-purple-500/20 rounded-lg p-4">
              <p className="text-white/80">
                ...
                Creators can establish donation centers and manage donations.
                Grant this role to trusted individuals only.
              </p>
            </div>
            ...
            <div className="backdrop-blur-md bg-purple-900/30 border border-purple-500/20 rounded-lg p-4">
              <p className="text-white/80">
                ...
                You are currently connected as the contract owner with address:{" "}
                <span className="font-mono text-[#FF00FF]">
            ...
            <div className="backdrop-blur-md bg-purple-900/30 border border-purple-500/20 rounded-lg p-4 flex items-start">
              ...
              <p className="text-white/80">
                Administrative actions are recorded on the blockchain and cannot
                be reversed. Please verify all addresses before granting or
                revoking creator roles.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-white/60 max-w-md mx-auto">
                There are currently no approved creators in the system. Use the
                form above to grant creator roles.
              </p>
            </div>
          )}
        </motion.div>
