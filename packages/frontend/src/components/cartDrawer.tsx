                                ...
                                <div className="mt-4 flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex items-center">
                                      <motion.button 
                                        whileTap={{ scale: 0.9 }}
                                        onClick={() => updateQuantity(item.id, item.quantity > 1n ? item.quantity - 1n : 1n)}
                                        className="w-8 h-8 flex items-center justify-center bg-white/10 text-white rounded-l-lg border border-white/20"
                                      >
                                        <ChevronDown size={16} />
                                      </motion.button>
                                      <div
                                        className="w-10 h-8 bg-white/10 border-y border-white/20 text-white flex items-center justify-center"
                                      >
                                        {item.quantity.toString()}
                                      </div>
                                      <motion.button 
                                        whileTap={{ scale: 0.9 }}
                                        onClick={() => updateQuantity(item.id, item.quantity + 1n)}
                ...
                <div className="border-t border-purple-500/20 p-6 space-y-6 backdrop-blur-sm relative z-10">
                  ...
                  <div className="space-y-4">
                    <motion.button
                      ...
                      disabled={loading === "eth" || state.total.eth === 0n}
                      className={`
                        w-full flex items-center justify-center gap-3 px-6 py-4 
                        rounded-xl text-lg font-medium
                        ${loading === "eth" || state.total.eth === 0n ? "opacity-50 cursor-not-allowed" : ""}
                    ...
                    <motion.button
                      ...
                      disabled={loading === "tokens" || state.total.tokens === 0n}
                      className={`
                        w-full flex items-center justify-center gap-3 px-6 py-4 
                        rounded-xl text-lg font-medium
                        ${loading === "tokens" || state.total.tokens === 0n ? "opacity-50 cursor-not-allowed" : ""}
